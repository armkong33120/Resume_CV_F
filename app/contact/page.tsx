      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-8 xs:mb-12 sm:mb-16 text-center">
          ...
          <p className="text-base xs:text-lg sm:text-xl text-foreground/70 max-w-xl mx-auto px-4">
            มีโปรเจกต์ที่น่าสนใจหรือต้องการปรึกษา? ยินดีติดต่อรับฟัง
          </p>
        </div>
          ...
          <div className="space-y-6 xs:space-y-8">
            ...
            {profile.social.line && (
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 xs:gap-4 pb-5 xs:pb-6 border-b border-border">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-foreground/60 mb-1">LINE</h3>
                  <a
            ...
            {profile.social.phone && (
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 xs:gap-4 pb-5 xs:pb-6 border-b border-border">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-foreground/60 mb-1">เบอร์โทรศัพท์</h3>
                  <a
            ...
            {profile.social.email && (
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 xs:gap-4 pb-5 xs:pb-6 border-b border-border">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-foreground/60 mb-1">อีเมล</h3>
                  <a
            ...
            {profile.birthday && (
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 xs:gap-4 pb-5 xs:pb-6 border-b border-border">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-foreground/60 mb-1">วันเกิด</h3>
                  <p className="text-lg sm:text-xl font-medium text-foreground">
                    {profile.birthday} ({profile.age ? `${profile.age} ปี` : ''})
                  </p>
                </div>
              </div>
            )}
            ...
            {profile.address && (
              <div className="flex flex-col sm:flex-row sm:items-start gap-3 xs:gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-foreground/60 mb-1">ที่อยู่</h3>
        ...
        {(profile.social.linkedin || profile.social.github) && (
          <div className="mt-8 xs:mt-12 text-center">
            <p className="text-xs xs:text-sm text-foreground/60 mb-4 xs:mb-6">หรือติดต่อผ่านช่องทางอื่น</p>
